    ...
    return Scaffold(
      ...
      body:  Center(child:Container(
        ...
        child: Column(
          ...
          children:<Widget> [
            ElevatedButton( child: Text("Simple Dialog"),onPressed: () {
              showDialog(
          context: context,
          builder: (BuildContext context) {
            ...
            ElevatedButton( child: Text("Alert Dialog"),onPressed: () {
              showDialog(
          context: context,
          builder: (BuildContext context) {
            return AlertDialog(
            ...
            ElevatedButton( child: Text("Date Picker Dialog"),onPressed: () {
      ...
      showDatePicker(
       ...
       // _showSnackBar('$onValue', 'ok');
            ...
            ElevatedButton( child: Text("Timer Picker Dialog"),onPressed: () {
              final DateTime now = DateTime.now();
      showTimePicker(
              context: context,
        ...
        //_showSnackBar(onValue?.format(context) ?? '', 'ok');
            ...
            ElevatedButton( child: Text("Cupertino Dialog"),onPressed: () {
              showDialog(
          context: context,
          builder: (BuildContext context) {
